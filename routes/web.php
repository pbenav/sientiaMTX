...
Route::prefix('citas')->name('public.appointments.')->middleware('throttle:60,1')->group(function () {
    ...
    Route::post('/service/{service}/add-immediate-capacity', [\App\Http\Controllers\Appointments\PublicAppointmentController::class, 'addImmediateCapacity'])->name('add-immediate-capacity');
