            ...
            <div class="flex items-center gap-3 flex-1">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3 mt-1">
                        <div class="p-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-xl shadow-sm border border-indigo-200 dark:border-indigo-800/30">
                        ...
                        <div>
                            ...
                            <x-demo-hint>
                                Centro de notificaciones unificado. Recibe alertas en tiempo real sobre tareas asignadas, recordatorios, menciones en el foro, reconocimientos o avisos del sistema (como los resúmenes matutinos).
                            </x-demo-hint>
                        </div>
                    </div>
                </div>
                                ...
                                @php
                                    ...
                                    switch($type) {
                                        ...
                                        case 'kudo_received':
                                            ...
                                            break;
                                        case 'task_quality_vote':
                                            $iconClass .= "bg-amber-100 text-amber-600 dark:bg-amber-900/30";
                                            $icon = '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>';
                                            break;
