                    ...
                    @forelse($activitiesByType as $type => $count)
                        @php
                            $typeLabel = match($type) {
                                'task' => 'Tareas',
                                'meeting' => 'Reuniones',
                                'appointment_meeting' => 'Citas Previas',
                                'document' => 'Documentos',
                                'note' => 'Notas',
                                'link' => 'Enlaces',
                                'agreement' => 'Acuerdos',
                            ...
                            $typeColor = match($type) {
                                ...
                                'appointment_meeting' => 'bg-cyan-50 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-400',
                                ...
                                'agreement' => 'bg-rose-50 text-rose-600 dark:bg-rose-500/10 dark:text-rose-400',
                            ...
                            $typeIcon = match($type) {
                                ...
                                'appointment_meeting' => '<svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>',
                                ...
                                'agreement' => '<svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" /></svg>',
