...
<div class="max-w-7xl mx-auto space-y-6 pb-12">
            ...
            <div class="relative overflow-hidden rounded-[2rem] bg-gray-900 p-8 shadow-lg border border-gray-800">
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    ...
                    <div class="flex gap-4">
                        <div class="bg-white/10 backdrop-blur-md rounded-2xl p-4 min-w-[160px] text-center border border-white/10">
                            <p class="text-[10px] text-gray-300 font-bold uppercase tracking-widest mb-1">Carga Operativa (30d)</p>
                            <p class="text-3xl font-black font-mono text-white">{{ number_format($auditData['system']['activities_30d']) }}</p>
                        </div>
                        <div class="bg-emerald-500/10 backdrop-blur-md rounded-2xl p-4 min-w-[160px] text-center border border-emerald-500/20">
                            <p class="text-[10px] text-emerald-400 font-bold uppercase tracking-widest mb-1">Uptime SLA</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Users -->
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[1.5rem] p-6 relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start mb-4 relative z-10">
                        ...
                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider {{ $growth >= 0 ? 'bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20' : 'bg-red-100 dark:bg-red-500/10 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-500/20' }}">
                            {{ $growth >= 0 ? '↑' : '↓' }} {{ abs($growth) }}%
                        </span>
                    </div>
                    <div class="relative z-10">
                        <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format($auditData['users']['total']) }}</p>
                        <h3 class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mt-1">Usuarios Totales</h3>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[1.5rem] p-6 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format($auditData['users']['active_now']) }}</p>
                        <h3 class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mt-1">Conectados Ahora</h3>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[1.5rem] p-6 relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start mb-4 relative z-10">
                        ...
                        <span class="text-[10px] font-black uppercase tracking-wider text-gray-500 bg-gray-100 dark:bg-white/5 px-2 py-1 rounded-full border border-gray-200 dark:border-white/10">{{ number_format($auditData['system']['total_attachments']) }} Ficheros</span>
                    </div>
                    <div class="relative z-10">
                        <p class="text-3xl font-black text-gray-900 dark:text-white">{{ $auditData['system']['db_size_mb'] }}<span class="text-lg text-purple-500 dark:text-purple-400 ml-1">MB</span></p>
                        <h3 class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mt-1">Volumen Base de Datos</h3>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[1.5rem] p-6 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format($auditData['users']['avg_session_minutes']) }}<span class="text-lg text-amber-500 dark:text-amber-400 ml-1">min</span></p>
                        <h3 class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mt-1">Media de Sesión</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Comms -->
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5 border border-gray-200 dark:border-white/5 hover:border-indigo-500/30 transition-all">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-8 h-8 rounded-lg bg-indigo-500/10 flex items-center justify-center text-indigo-500 dark:text-indigo-400">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                        </div>
                        <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Comunicaciones</h4>
                    </div>
                    <p class="text-2xl font-black text-gray-900 dark:text-white">{{ number_format($auditData['modules']['comms']['total']) }} <span class="text-[10px] text-gray-500 font-normal uppercase tracking-widest block mt-1">Mensajes Totales</span></p>
                    <div class="mt-3 pt-3 border-t border-gray-200 dark:border-white/5 flex justify-between items-center text-xs">
                        <span class="text-gray-500">Volumen Mes</span>
                        <span class="text-indigo-500 dark:text-indigo-400 font-bold">+{{ number_format($auditData['modules']['comms']['this_month']) }}</span>
                    </div>
                </div>

                <!-- Gamification -->
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5 border border-gray-200 dark:border-white/5 hover:border-pink-500/30 transition-all">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-8 h-8 rounded-lg bg-pink-500/10 flex items-center justify-center text-pink-500 dark:text-pink-400">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>
                        </div>
                        <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Gamificación</h4>
                    </div>
                    <p class="text-2xl font-black text-gray-900 dark:text-white">{{ number_format($auditData['modules']['gamification']['total_kudos']) }} <span class="text-[10px] text-gray-500 font-normal uppercase tracking-widest block mt-1">Kudos Repartidos</span></p>
                    <div class="mt-3 pt-3 border-t border-gray-200 dark:border-white/5 flex justify-between items-center text-xs">
                        <span class="text-gray-500">Últimos 30d</span>
                        <span class="text-pink-500 dark:text-pink-400 font-bold">+{{ number_format($auditData['modules']['gamification']['kudos_30d']) }}</span>
                    </div>
                </div>

                <!-- Expedientes -->
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5 border border-gray-200 dark:border-white/5 hover:border-orange-500/30 transition-all">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-8 h-8 rounded-lg bg-orange-500/10 flex items-center justify-center text-orange-500 dark:text-orange-400">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        </div>
                        <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Expedientes</h4>
                    </div>
                    <p class="text-2xl font-black text-gray-900 dark:text-white">{{ number_format($auditData['modules']['expedientes']['total']) }} <span class="text-[10px] text-gray-500 font-normal uppercase tracking-widest block mt-1">Registros Históricos</span></p>
                    <div class="mt-3 pt-3 border-t border-gray-200 dark:border-white/5 flex justify-between items-center text-xs">
                        <span class="text-gray-500">Abiertos Ahora</span>
                        <span class="text-orange-500 dark:text-orange-400 font-bold">{{ number_format($auditData['modules']['expedientes']['active']) }}</span>
                    </div>
                </div>

                <!-- Encuestas / Satisfacción -->
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-5 border border-gray-200 dark:border-white/5 hover:border-teal-500/30 transition-all">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-8 h-8 rounded-lg bg-teal-500/10 flex items-center justify-center text-teal-500 dark:text-teal-400">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
                        </div>
                        <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Satisfacción</h4>
                    </div>
                    <p class="text-2xl font-black text-gray-900 dark:text-white">{{ number_format($auditData['modules']['surveys']['total']) }} <span class="text-[10px] text-gray-500 font-normal uppercase tracking-widest block mt-1">Encuestas Creadas</span></p>
                    <div class="mt-3 pt-3 border-t border-gray-200 dark:border-white/5 flex justify-between items-center text-xs">
                        <span class="text-gray-500">Votos Emitidos</span>
                        <span class="text-teal-500 dark:text-teal-400 font-bold">{{ number_format($auditData['modules']['surveys']['votes']) }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Login Trend -->
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[2rem] p-6 lg:p-8">
                    <div class="mb-4 flex justify-between items-start">
                        <div>
                            <h2 class="text-base font-black text-gray-900 dark:text-white uppercase tracking-widest">Flujo de Accesos</h2>
    ...
    <div x-cloak x-show="tooltip" x-transition.opacity.duration.200ms class="absolute bottom-full right-0 mb-2 w-max max-w-xs px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-[11px] font-medium rounded-lg shadow-xl pointer-events-none z-50 whitespace-normal text-left">
        ...
        <div class="absolute top-full right-2 w-2 h-2 bg-gray-900 dark:bg-gray-700 transform rotate-45 -mt-1"></div>
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[2rem] p-6 lg:p-8">
                    <div class="mb-4 flex justify-between items-start">
                        <div>
                            <h2 class="text-base font-black text-gray-900 dark:text-white uppercase tracking-widest">Carga Transaccional</h2>
    ...
    <div x-cloak x-show="tooltip" x-transition.opacity.duration.200ms class="absolute bottom-full right-0 mb-2 w-max max-w-xs px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-[11px] font-medium rounded-lg shadow-xl pointer-events-none z-50 whitespace-normal text-left">
        ...
        <div class="absolute top-full right-2 w-2 h-2 bg-gray-900 dark:bg-gray-700 transform rotate-45 -mt-1"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <!-- Top Users -->
                <div class="lg:col-span-2 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[2rem] p-6 lg:p-8">
                    <div class="mb-6 flex flex-wrap justify-between items-end gap-4">
                        <div>
                            <h2 class="text-base font-black text-gray-900 dark:text-white uppercase tracking-widest">Líderes de Operativa</h2>
        ...
        <div class="absolute top-full right-2 w-2 h-2 bg-gray-900 dark:bg-gray-700 transform rotate-45 -mt-1"></div>
                    ...
                    <div class="space-y-3">
                        @forelse($auditData['top_performers'] as $index => $user)
                            <div class="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 hover:bg-gray-100 dark:hover:bg-white/10 transition-all group">
                                ...
                                <div class="text-right">
                                    <p class="text-xl font-black text-gray-900 dark:text-white group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">{{ number_format($user->total_tasks) }}</p>
                                    <p class="text-[9px] uppercase font-bold text-gray-500 tracking-widest">Actividades</p>
                                </div>
                            </div>
                        @empty
                            <div class="text-center py-10 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/5">
                ...
                <!-- Status Breakdown -->
                <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm rounded-[2rem] p-6 lg:p-8 flex flex-col">
                    <div class="mb-4 flex justify-between items-start">
                        <div>
                            <h2 class="text-base font-black text-gray-900 dark:text-white uppercase tracking-widest">Distribución de Estados</h2>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const gridColor = document.documentElement.classList.contains('dark') ? '#1f2937' : '#f3f4f6';
