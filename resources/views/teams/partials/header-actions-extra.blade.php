            ...
            <div class="relative items-center" x-data="{ open: false }">
                 ...
                 <div x-show="open" x-transition x-cloak style="display: none"
                      ...
                      <div class="p-3 border-b border-gray-50 dark:border-gray-800 bg-emerald-50/30 dark:bg-emerald-900/20 flex justify-between items-center">
                          ...
                          <button @click.stop="open = false; $dispatch('open-last-chat')" class="text-[10px] font-bold text-gray-500 hover:text-emerald-600 dark:text-gray-400 dark:hover:text-emerald-400 transition-colors bg-white dark:bg-gray-800 px-2 py-1 rounded shadow-sm border border-gray-100 dark:border-gray-700">
                              Abrir Último Chat
                          </button>
                      </div>
                      <div class="max-h-64 overflow-y-auto custom-scrollbar">
                          <template x-if="$store.chatStore.totalCount === 0">
                              <div class="p-6 text-center">
                                  ...
                                  <button @click="open = false; $dispatch('open-last-chat')" class="px-4 py-2 bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400 rounded-xl text-xs font-bold hover:bg-emerald-100 dark:hover:bg-emerald-500/20 transition-colors">
                      ...
                      <template x-if="$store.chatStore.totalCount > 0">
                          <div class="p-2 border-t border-gray-50 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50">
                              <button @click="open = false; $dispatch('open-last-chat')" class="w-full py-2 text-[11px] font-black text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 text-center transition-colors uppercase tracking-wider">
                                  Ver último chat
                              </button>
                          </div>
                      </template>
