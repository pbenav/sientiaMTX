...
@if($isVisibleView)
    <button onclick="toggleGlobalSubtasks()" 
        ...
        class="flex flex-col items-center justify-center gap-0.5 px-1.5 md:px-2 py-2 rounded-xl transition-all shrink-0 min-w-max {{ $showSubtasks ? 'text-violet-600 dark:text-violet-400 bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-white/60 dark:hover:bg-gray-700/60' }}">
        ...
        <span class="hidden lg:block text-[9px] font-bold uppercase tracking-tight whitespace-nowrap leading-none">Subtareas</span>
    </button>
