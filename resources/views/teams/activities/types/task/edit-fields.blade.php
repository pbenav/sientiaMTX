                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
                    <div class="relative flex items-center gap-3 group">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="radio" id="limit_type_count_2" name="autoprogram_settings[limit_type]" value="count"
                        ...
                        <input type="number" onclick="document.getElementById('limit_type_count_2').checked = true" name="autoprogram_settings[limit_value_count]"
                    ...
                    <div class="relative flex items-center gap-3 group">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="radio" id="limit_type_date_2" name="autoprogram_settings[limit_type]" value="date"
                        ...
                        <input type="date" onclick="document.getElementById('limit_type_date_2').checked = true" name="autoprogram_settings[limit_value_date]"
                            value="{{ $limitValDate }}"
