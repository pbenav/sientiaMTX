            ...
            <div class="lg:col-span-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-amber-700 dark:text-amber-300">Puedes forzar la creación de citas en tramos horarios que ya están llenos <strong>únicamente para el día de hoy</strong>.</p>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-3xl border border-gray-150 dark:border-gray-800 shadow-sm p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-12">
                    ...
                    <input type="email" id="input-email" name="email" value="{{ old('email') }}" required oninput="this.value = this.value.toLowerCase()"
                ...
                <div class="md:col-span-4">
                    ...
                    <input type="text" id="input-dni" name="dni" value="{{ old('dni') }}" required autocomplete="off" oninput="this.value = this.value.toUpperCase()"
    ...
    document.addEventListener("DOMContentLoaded", function () {
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    slots.forEach(slot => {
                        ...
                        btn.className = isEffectivelyFull 
        ...
        function selectTime(timeStr, btn) {
            document.querySelectorAll('.slot-btn').forEach(b => {
                // Restaurar clases según si es un slot forzado o no
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            ...
                            }, 500); // Dar tiempo a loadSlots a completarse
                        }, 200);
