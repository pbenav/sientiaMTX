<x-app-layout>
    @section('title', 'Crear Micrositio')
    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white heading">Nuevo Micrositio</h1>
    ...
    <div class="pt-12 pb-32 px-4">
        <div class="max-w-5xl mx-auto">
            ...
            <form id="microsite-form" action="{{ route('teams.microsites.store', $team) }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 md:p-8 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-[52px]">Si está desmarcado, nadie podrá verlo excepto tú.</p>
                        </div>
                    </div>
                </div>
