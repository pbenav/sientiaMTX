<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('settings.users.bulk-email') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-emerald-500/20">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    {{ __('Enviar Correo / Invitar') }}
                </a>
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                @if($user->invitations_left > 0)
                                                    <span class="inline-flex items-center gap-1 text-[10px] text-amber-500 font-bold uppercase mt-0.5">
                                                        ...
                                                        {{ trans_choice('{1} :count Invitación disponible|[2,*] :count Invitaciones disponibles', $user->invitations_left, ['count' => $user->invitations_left]) }}
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
