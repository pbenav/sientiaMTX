        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div
                ...
                <div class="p-8">
                    ...
                    <!-- Explanatory Text -->
                    <div class="mb-8 p-4 bg-violet-50 dark:bg-gray-800/50 border border-violet-100 dark:border-violet-500/30 rounded-xl text-sm text-violet-800 dark:text-violet-300">
                        ...
                        <p class="mb-2">{{ __('These parameters represent the "Identity" of your app. Once configured, each user can independently authorize the app to access their own data.') }}</p>
                        <p>{{ __('Individual access tokens are stored securely for each user; they never share calendar or mail data.') }}</p>
                    </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="GOOGLE_CLIENT_ID" name="GOOGLE_CLIENT_ID" type="text"
                                    class="mt-1 block w-full" :value="old('GOOGLE_CLIENT_ID', $google['client_id'])" placeholder="xxxxx.apps.googleusercontent.com" />
                            ...
                            <!-- Redirect URI Guide -->
                            <div>
                                <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400 mb-1">{{ __('Authorized Redirect URI') }}</p>
                                <div class="bg-gray-100 dark:bg-gray-900 p-2 rounded-lg font-mono text-[10px] break-all select-all border border-gray-200 dark:border-gray-800">
                                    {{ $google['redirect_uri'] }}
                                </div>
                                <p class="text-[10px] text-gray-500 mt-1 italic">{{ __('Add this URL to your Google Cloud Console project settings.') }}</p>
                            </div>
                        </div>

                        <div
                            class="flex items-center justify-end pt-6 border-t border-gray-100 dark:border-gray-800">
                            <x-primary-button class="px-8 py-3 bg-red-600 hover:bg-red-500 focus:bg-red-500 active:bg-red-700">
