                ...
                <div class="flex items-center gap-1 sm:gap-3">
                    ...
                    @auth
                        ...
                        <a href="{{ route('teams.index') }}"
                            class="hidden sm:flex flex-col items-center justify-center min-w-[3rem] lg:min-w-[4rem] px-2 h-14 text-gray-500 dark:text-gray-400 hover:text-violet-600 dark:hover:text-violet-400 transition-all rounded-xl hover:bg-violet-50 dark:hover:bg-violet-500/10 relative group"
                        ...
                        @can('admin')
                            ...
                            <a href="{{ route('settings.mail') }}"
                                class="hidden sm:flex flex-col items-center justify-center min-w-[3rem] lg:min-w-[5.5rem] px-2 h-14 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 {{ request()->routeIs('settings.mail*') ? 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white' : '' }}"
