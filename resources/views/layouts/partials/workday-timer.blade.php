    ...
    <div x-show="working" x-cloak
        ...
        <template x-if="activeTaskTitle">
            <div class="flex items-center gap-1.5 pl-1.5 ml-1.5 border-l border-violet-200 dark:border-violet-700 min-w-0 overflow-hidden">
                ...
                <a :href="'/teams/' + activeTaskTeamId + '/tasks/' + activeTask" 
                   class="text-[10px] font-bold text-violet-700 hover:text-violet-900 dark:text-violet-300 dark:hover:text-violet-100 hover:underline truncate max-w-[60px] sm:max-w-[100px] lg:max-w-[150px]" 
