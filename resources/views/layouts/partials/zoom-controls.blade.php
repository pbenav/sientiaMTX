<div class="relative" x-data="{ 
    ...
    tempZoom: parseFloat(localStorage.getItem('global_zoom') || '1.0'),
    dragging: false,
    updateZoom(val) {
    ...
    <div x-show="open" 
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <button @click="updateZoom(1.0); tempZoom = 1.0" 
                    ...
                    <span x-text="Math.round(tempZoom * 100) + '%'"></span>
                </button>
            </div>
            ...
            <div class="flex items-center gap-3 bg-gray-50 dark:bg-gray-900/50 p-3 rounded-xl border border-gray-100 dark:border-gray-800">
                <!-- Alejar -->
                <button @click="tempZoom = Math.max(0.5, tempZoom - 0.05); updateZoom(tempZoom)" class="text-gray-400 hover:text-violet-500 transition-colors shrink-0">
                ...
                <input type="range" min="0.5" max="1.5" step="0.05" 
                    ...
                    @input="tempZoom = $event.target.value"
                ...
                <!-- Acercar -->
                <button @click="tempZoom = Math.min(1.5, tempZoom + 0.05); updateZoom(tempZoom)" class="text-gray-400 hover:text-violet-500 transition-colors shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
            ...
            <div class="flex justify-between px-1">
                ...
                <div class="flex gap-1 items-center">
                    <div class="w-1 h-1 rounded-full" :class="tempZoom == 1.0 ? 'bg-violet-500' : 'bg-gray-300'"></div>
                    <span class="text-[9px] font-bold" :class="tempZoom == 1.0 ? 'text-violet-500' : 'text-gray-500'">100%</span>
                </div>
