<div class="relative" x-data="{ 
    ...
    <!-- Desplegable con Slider (Ancho ampliado a w-72) -->
    <div x-show="open" 
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <button @click="updateZoom(100); tempZoomVal = 100" 
                        class="text-[10px] font-black text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-900/30 px-2 py-1 rounded-lg hover:scale-105 transition-transform"
            ...
            <div class="flex items-center gap-3 bg-gray-50 dark:bg-gray-900/50 p-3 rounded-xl border border-gray-100 dark:border-gray-800">
                <!-- Alejar -->
                <button @click="tempZoomVal = Math.max(50, parseInt(tempZoomVal) - 5); updateZoom(tempZoomVal)" class="text-gray-400 hover:text-violet-500 transition-colors shrink-0">
                ...
                <!-- Acercar -->
                <button @click="tempZoomVal = Math.min(150, parseInt(tempZoomVal) + 5); updateZoom(tempZoomVal)" class="text-gray-400 hover:text-violet-500 transition-colors shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
