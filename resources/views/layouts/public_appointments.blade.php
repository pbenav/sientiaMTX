        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <a href="{{ route('public.appointments.map') }}" class="flex items-center gap-2.5 group">
                ...
                <div>
                    ...
                    <span class="block text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest leading-none">Portal Ciudadano</span>
                </div>
            </a>
            
            <div class="flex items-center gap-3">
                <button id="theme-toggle" class="p-2.5 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700/50 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors" title="Cambiar tema">
