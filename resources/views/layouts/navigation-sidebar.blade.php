                ...
                <div class="mt-auto pt-6 border-t border-gray-100 dark:border-gray-800">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('metrics.index') }}"
                            class="flex items-center gap-3 px-3 py-2 text-sm font-bold text-indigo-600 dark:text-indigo-400 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all">
                        ...
                        <form method="POST" action="{{ route('profile.toggle-privacy-mode') }}">
                            @csrf
                            <button type="submit"
                                class="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium {{ $isDemoMode ? 'text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white' }} rounded-xl transition-all text-left">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    @if($isDemoMode)
