            ...
            <form id="edit-task-form" method="POST" action="{{ route('teams.tasks.update', [$team, $task]) }}" class="space-y-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 mb-8 space-y-6 transition-all shadow-sm">
                    ...
                    <div>
                        ...
                        @if($task->parent_id && !$task->is_template)
                            <div class="flex items-center justify-between bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center gap-3">
                                    @if($task->expediente)
                                        ...
                                        <span class="text-sm font-bold text-gray-700 dark:text-gray-300">{{ $task->expediente->title }}</span>
                                    @else
                                        <span class="text-sm text-gray-400 italic">{{ __('(Ningún expediente)') }}</span>
                                    @endif
                                </div>
                            ...
                            <input type="hidden" name="expediente_id" value="{{ $task->expediente_id }}">
                        @else
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
                                <div class="relative flex items-center gap-3 group">
                                    <label class="flex items-center gap-3 cursor-pointer">
                                        <input type="radio" id="limit_type_count_3" name="autoprogram_settings[limit_type]" value="count"
                                            {{ $limitType === 'count' ? 'checked' : '' }} class="w-4 h-4 text-violet-600 border-gray-300 focus:ring-violet-500 dark:border-gray-600 dark:bg-gray-800 dark:focus:ring-violet-600 dark:focus:ring-offset-gray-900 transition-all cursor-pointer">
                                        <span
                                    ...
                                    <input type="number" onclick="document.getElementById('limit_type_count_3').checked = true" name="autoprogram_settings[limit_value_count]"
                                ...
                                <div class="relative flex items-center gap-3 group">
                                    <label class="flex items-center gap-3 cursor-pointer">
                                        <input type="radio" id="limit_type_date_3" name="autoprogram_settings[limit_type]" value="date"
                                            {{ $limitType === 'date' ? 'checked' : '' }} class="w-4 h-4 text-violet-600 border-gray-300 focus:ring-violet-500 dark:border-gray-600 dark:bg-gray-800 dark:focus:ring-violet-600 dark:focus:ring-offset-gray-900 transition-all cursor-pointer">
                                        <span
                                    ...
                                    <input type="date" onclick="document.getElementById('limit_type_date_3').checked = true" name="autoprogram_settings[limit_value_date]"
                                        value="{{ $limitValDate }}"
                ...
                <div class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_timeline_locked" value="1" {{ old('is_timeline_locked', $task->is_timeline_locked) ? 'checked' : '' }} class="sr-only peer">
                ...
                <div class="pt-8 border-t border-gray-100 dark:border-gray-800">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            @endif
                            <label for="attachment-input" class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-violet-600 dark:text-violet-400 text-xs font-bold px-4 py-2 rounded-xl border border-violet-200 dark:border-violet-800 transition-all shadow-sm flex items-center gap-2 cursor-pointer mb-0 inline-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                                        d="M12 4v16m8-8H4" />
