    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-24 lg:pb-0">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <script>
                ...
                @include('tasks.partials.task-attachments')
        <!-- Sidebar -->
        <div class="space-y-4">

                @include('tasks.partials.task-quality-rating')
                @include('tasks.partials.task-edit-fields')
                @include('tasks.partials.task-timeline')
                @include('tasks.partials.task-forum')
    @include('tasks.partials.task-js-modals')
</x-app-layout>
