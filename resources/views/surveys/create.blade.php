<x-app-layout>
            ...
            <div class="flex items-start gap-4 min-w-0 flex-1">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white tracking-tight flex items-center gap-3 mb-1">
                        ...
                        {{ $isGlobal ? __('Lanzar Encuesta Global') : __('Lanzar Nueva Encuesta') }}
                    </h1>
                    <p class="text-gray-500 dark:text-gray-400 font-medium text-sm">
                        {{ $isGlobal 
                            ? __('Diseña una consulta para toda la organización. Como administrador, tu voz llega a todos.') 
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 min-h-screen" 
        ...
        <div class="max-w-[1600px] mx-auto">
            ...
            <form action="{{ route($routePrefix . 'store', $team ? [$team] : []) }}" method="POST" id="survey-create-form">
                @csrf
    ...
    <script>
        function surveyManager() {
            return {
                ...
                addOption(qIndex) {
                    this.questions[qIndex].options.push({ label: '' });
                },
