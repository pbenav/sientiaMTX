                        ...
                        @forelse($blocks as $block)
                            <div class="flex items-start gap-4 p-4 hover:bg-red-50/30 dark:hover:bg-red-900/10 transition-colors group">
                                ...
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('appointments.blocks.edit', [$team, $block]) }}" class="p-2 text-gray-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl transition-all">
                                    ...
                                    <form method="POST" action="{{ route('appointments.blocks.destroy', [$team, $block]) }}"
                                        ...
                                        @csrf @method('DELETE')
                                        <button type="submit" class="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all">
