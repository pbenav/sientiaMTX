                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                                    ...
                                    <td class="px-5 py-3.5 text-right">
                                        <div class="flex items-center justify-end gap-3">
                                            ...
                                            <form method="POST" action="{{ route('appointments.forceDestroy', [$team, $cita]) }}" class="inline-block opacity-0 group-hover:opacity-100 transition-opacity" onsubmit="return confirm('¿⚠️ ELIMINAR FÍSICAMENTE ESTA CITA? Se borrará permanentemente junto con su tarea asociada.')">
                                                @csrf @method('DELETE')
