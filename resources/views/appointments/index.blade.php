        ...
        <div class="flex items-center gap-3 shrink-0">
            @if($settings && $settings->public_slug)
                <a href="{{ route('public.appointments.member', $settings->public_slug) }}" target="_blank"
                   class="flex items-center gap-2 text-xs bg-emerald-600 hover:bg-emerald-500 text-white px-5 py-2.5 rounded-xl transition-all font-black shadow-lg shadow-emerald-500/20 active:scale-95">
