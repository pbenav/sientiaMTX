                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form method="POST" action="{{ route('appointments.visitors.destroy', [$team, $visitor]) }}"
                                              onsubmit="return confirm('⚠️ ELIMINACIÓN DEFINITIVA (Ley del Olvido)\n\n¿Eliminar a esta persona? Esta acción es IRREVERSIBLE y eliminará:\n\n• Todos los datos personales (nombre, DNI, email, teléfono, dirección)\n• TODAS las citas asociadas, sin importar la fecha (pasado, presente o futuro)\n\nEsta acción cumple con la ley del olvido y no se puede deshacer.');
                                            @csrf @method('DELETE')
