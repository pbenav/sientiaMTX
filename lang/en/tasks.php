...
return [
    ...
    'gantt_no_tasks_help' => 'There are no activities matching current filters.',
    'gantt_hint_tooltip' => 'Tasks with a deadline appear solid. Open-ended tasks appear with dashed borders and a fading gradient.',
    'gantt_open_deadline' => 'Open deadline',
    ...
    'attachment_uploaded' => 'Attachment successfully uploaded.',
    'rename_attachment' => 'Rename attachment',
    'delete_attachment_confirm' => 'Are you sure you want to delete this file?',
    'new_name' => 'New name',
    'manage_attachments_hint' => 'Manage this task\'s attachments',
    'attachments_hint' => 'Upload files relevant to this task (Images, PDF, etc.)',
    'members' => 'Members',
    'personal_instance_notice_others' => 'Private instance of :name',
    'personal_instance_description_others' => 'Changes made here only affect this instance. Progress will be reflected in the team\'s overall goal.',
    'notifications' => [
        'completed_alert' => '✅ Task completed: ":title"',
        'completed_body' => ':user has finished the task ":title".',
    ],
    'shared' => 'Shared / Master',
    'sync_members' => 'Sync Members',
    'hours' => 'Hours',
    'lead_time' => 'Creation lead time (wake up)',
    'lead_time_hint' => 'before the target date',
    'autoprogram_active' => 'JIT Auto-scheduling',
    'next_wakeup' => 'Next wake up',
    'all_time' => 'Any date',
    ...
    'shared_task' => 'Shared Task (Collaborative)',
    'shared_hint' => 'This is a SINGLE task. Everyone works on it, shares progress, and time is aggregated.',
    'distributed_task' => 'Master Plan (Distribution)',
    'distributed_hint' => 'Creates a global container (read-only) and generates an independent copy (instance) for each assigned member.',
    'view_or_download' => 'View or download',
    'select_from_drive' => 'Select from Drive',
    'drive_explorer' => 'Google Drive Explorer',
    'collaborative_hint' => 'In collaborative tasks, progress is shared among all members.',
];
